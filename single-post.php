        ...
        <div class="col-sm-8 blog-main">
            ...
            <?php
                if (isset($_GET['post_id'])) {
                    ...
                    $genderClass = $post['gender'] === 'M' ? 'author-male' : 'author-female';
            ...
            ?>
                ...
                <div class="blog-post">
                    ...
                    <p class="blog-post-meta"><?php echo DateTime::createFromFormat('Y-m-j', $post['created_at'])->format('M j, Y');?> by <a class="<?php echo $genderClass;?>" href="#"><?php echo $post['firstname'] . ' ' . $post['lastname']; ?></a></p>
